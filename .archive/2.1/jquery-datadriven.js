...
(function($) {
  ...
  $.ui.autocomplete.prototype._create = function(){
    ...
    $( _element ).autocomplete({
      response: function( event, ui ) { console.log(event, ui); }
    });
        ...
        getOptions: function($target, inst) {
          ...
          var maxDate = $.ddui.helpers.splitString($target.data('ui-datepicker-maxdate'), ',', true),
              ...
              beforeShow = function(el) {
                ...
                var defaultMaxdate = maxDate[0] ? maxDate[0] instanceof Date ? maxDate[0] : _datepicker._determineDate(maxDate[0]) : null,
                    defaultMindate = minDate[0] ? minDate[0] instanceof Date ? minDate[0] : _datepicker._determineDate(minDate[0]) : null,
                ...
                maxdate = defaultMaxdate && maxdate > new Date(defaultMaxdate) || maxdate === undefined ? defaultMaxdate : maxdate;
                mindate = defaultMindate && mindate < new Date(defaultMindate) || mindate === undefined ? defaultMindate : mindate;
        ...
        $(sel)
          .find('[data-role]')
            ...
            .filter('[data-role="autocomplete"]').autocomplete()
              .end()
            .filter('[data-role="button"]').button()
              .end()

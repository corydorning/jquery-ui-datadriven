...
;(function($) {
  ...
  $.ui.accordion.prototype._create = function(){
    ...
    // override options with data-*
      options = {
        ...
        icons: {
          activeHeader: _element.data('ui-icon-active') || _this.options.icons.headerSelected,
  ...
  var _datepicker = {
    // ui methods
    connect: $.datepicker.constructor.prototype._connectDatepicker,
    inline: $.datepicker.constructor.prototype._inlineDatepicker,
          ...
          beforeShow = function(el, obj) {
            if (maxDate[2] && minDate[2]) {
              $(this).datepicker('option', {
                maxDate: $(maxDate[2]).datepicker('getDate'), // get value of first item in collection
                minDate: $(minDate[2]).datepicker('getDate') // get value of first item in collection
              });
            } else if (maxDate[2]) {
              $(this).datepicker('option', 'maxDate', $(maxDate[2]).datepicker('getDate')); // get value of first item in collection
            } else if (minDate[2]) {
              $(this).datepicker('option', 'minDate', $(minDate[2]).datepicker('getDate')); // get value of first item in collection
            }
          },
  ...
  $.datepicker.constructor.prototype._connectDatepicker = function(target, inst) {
    ...
    _datepicker.connect.apply(_this, arguments );
  };
  ...
  $.datepicker.constructor.prototype._inlineDatepicker = function(target, inst) {
    ...
    // call the the attachDatepicker function
    _datepicker.inline.apply(_this, arguments );
  };
  ...
  $.ui.dialog.prototype._create = function(){
    ...
    // override options with data-*
      options = {
        ...
        dialogClass: _element.data('ui-dialog-class') || _this.options.closeOnEscape,
        ...
        modal: _element.data('ui-dialog-modal') || _element.hasClass('modal') || this.options.modal,
        position: {
          my: 'center',
          at: 'center',
          collision: 'fit',
        ...
        resizable: _element.data('ui-dialog-resizable') || _this.options.resizable,
        //show: null,
        //stack: true,
